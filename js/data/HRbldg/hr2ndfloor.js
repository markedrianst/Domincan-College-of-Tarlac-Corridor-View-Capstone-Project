const hr2ndfloor = [
...

  {
    ...
    arrowPositions: {
      'Hr2nd3': { phi: Math.PI / 3, theta: Math.PI * .92, direction: 'up' },
      'Hr2nd1': { phi: Math.PI / 3, theta: Math.PI * 1.97, direction: 'up' },
      'Hr1rd4': { phi: Math.PI / 3.6, theta: Math.PI * 1.60, direction: 'down' }
    }
  },

  {
    ...
    name: 'HR 2ND2',
    description: 'HR bldg. 2nd floor',
    imageUrl: 'images/HRbldg/HR2ndfloor3.jpg',
    category: ['HR bldg.'],
